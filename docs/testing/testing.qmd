...
```{.python filename="matrix_derivative_v1.py"}
import numpy as np
...
```{.python filename="test_matrix_derivative_v1.py"}
import numpy as np
...
```{.python filename="test_matrix_derivative_v2.py"}
import numpy as np
...
```{.python filename="test_matrix_derivative_v3.py"}
import numpy as np
from numpy.typing import NDArray
...
```{.python filename="test_matrix_derivative_v4.py"}
import numpy as np
from numpy.typing import NDArray
...
```{.python filename="matrix_derivative_v2.py"}
import numpy as np
from numpy.typing import NDArray
...
If we update the tests to use the corrected implementation, we obtain

```{.python filename="test_matrix_derivative_v5.py"}
import numpy as np
from numpy.typing import NDArray
